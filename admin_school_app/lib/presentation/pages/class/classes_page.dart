    ...
    return MainLayout(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton.extended(
          ...
          label: const Text('Adaugă Clasă', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
        ),
      ),
      child: Column(
        children: [
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: DataTable(
                        ...
                        rows: controller.classes.map((classEntity) {
                          return DataRow(
                            cells: [
                              DataCell(Text(classEntity.id?.toString() ?? '-')),
                              DataCell(Text(classEntity.name)),
                              DataCell(Text(classEntity.schoolId.toString())),
                              DataCell(Text(classEntity.gradeId.toString())),
                              DataCell(
                                Row(
                                  ...
                                  children: [
                                    IconButton(
                                      ...
                                      onPressed: () => Get.to(() => ClassFormPage(classId: classEntity.id)),
                                    ),
                                    IconButton(
                                      icon: Container(
                                        padding: const EdgeInsets.all(8),
                                      ...
                                      onPressed: () => _showDeleteDialog(controller, classEntity.id!),
                                    ),
                                  ],
                                ),
                              ),

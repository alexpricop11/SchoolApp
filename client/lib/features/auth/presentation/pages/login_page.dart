import 'package:SchoolApp/features/auth/presentation/pages/set_password_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final emailHint = (!emailFocusNode.hasFocus && emailController.text.isEmpty) ? 'ex: ion.popescu@mail.com' : null;
                ...
                children: [
                  ...
                  Center(
                    child: LoginCard(
                      ...
                      onForgotPassword: () {
                        Get.to(() => ForgotPasswordPage(initialEmail: emailController.text.trim()));
                      },
                    ),
                  ),
